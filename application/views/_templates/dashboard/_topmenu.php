<a href="<?=base_url('dashboard')?>" class="logo">
    ...
    <img width=50 height=50 src="<?=base_url()?>assets/dist/img/logo.gif" class="user-image" alt="User Image">
    </span>
    <span class="logo-lg">
    <img width=45 height=45 src="<?=base_url()?>assets/dist/img/logo.gif" class="img-circle" alt="User Image">
    <b>R</b>uang <b>U</b>jian
    </span>
</a>
